...
schemaBuilderProto.prismaObject = function prismaObject(type, { fields, findUnique, select, include, description, ...options }) {
    ...
    this.objectType(ref, {
        ...
        name,
        fields: fields ? ()=>fields(new _prismafieldbuilder.PrismaObjectFieldBuilder(name, this, type, (0, _relationmap.getRelationMap)((0, _getclient.getDMMF)(this)).get(type))) : undefined
    });
    return ref;
};
...
schemaBuilderProto.prismaNode = function prismaNode(type, { id: { field, resolve: rawResolve, ...idOptions }, findUnique: rawFindUnique, name, variant, nullable, ...options }) {
    ...
    if (!interfaceRef) {
        throw new _core.PothosError('builder.prismaNode requires @pothos/plugin-relay to be installed');
    }
    ...
    this.configStore.onTypeConfig(ref, (nodeConfig)=>{
        ...
        this.objectField(ref, (_this_options_relayOptions_idFieldName = (_this_options_relayOptions = this.options.relayOptions) === null || _this_options_relayOptions === void 0 ? void 0 : _this_options_relayOptions.idFieldName) !== null && _this_options_relayOptions_idFieldName !== void 0 ? _this_options_relayOptions_idFieldName : 'id', (t)=>{
            ...
            return t.globalID({
                ...
                nullable: false,
                args: {},
                resolve: (parent, args, context, info)=>(0, _core.completeValue)(resolve(parent, context), (id)=>({
