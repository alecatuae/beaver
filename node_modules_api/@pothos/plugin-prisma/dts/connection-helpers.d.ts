import { InputFieldMap, InputShapeFromFields, SchemaTypes } from '@pothos/core';
...
export declare function prismaConnectionHelpers<Types extends SchemaTypes, RefOrType extends PrismaRef<PrismaModelTypes> | keyof Types['PrismaTypes'], Select extends Model['Select'] & {}, Model extends PrismaModelTypes = RefOrType extends PrismaRef<infer T> ? PrismaModelTypes & T : PrismaModelTypes & Types['PrismaTypes'][RefOrType & keyof Types['PrismaTypes']], Shape = RefOrType extends PrismaRef<PrismaModelTypes, infer T> ? T : Model['Shape'], EdgeShape = Model['Include'] extends Select ? Shape : ShapeFromSelection<Types, Model, {
    select: Select;
    ...
    getQuery: (args: InputShapeFromFields<ExtraArgs> & PothosSchemaTypes.DefaultConnectionArguments, ctx: Types['Context'], nestedSelection: <T extends true | {}>(selection?: T, path?: string[]) => T) => (Model["Select"] extends Select ? {} : {
        ...
        where?: Model["Where"] | undefined;
        orderBy?: Model["OrderBy"] | undefined;
        skip?: number | undefined;
        take?: number | undefined;
        cursor?: Model["WhereUnique"] | undefined;
    };
    getArgs: () => ExtraArgs;
};
