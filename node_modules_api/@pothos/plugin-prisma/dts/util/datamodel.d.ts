...
export declare const refMap: WeakMap<object, Map<string, PrismaRef<PrismaModelTypes>>>;
export declare const findUniqueMap: WeakMap<object, Map<ObjectRef<unknown>, ((args: unknown, ctx: {}) => unknown) | null>>;
export declare const includeForRefMap: WeakMap<object, Map<ObjectRef<unknown>, Record<string, unknown> | null>>;
export declare function getRefFromModel<Types extends SchemaTypes>(name: string, builder: PothosSchemaTypes.SchemaBuilder<Types>, type?: 'interface' | 'object'): PrismaRef<PrismaModelTypes>;
