/* eslint-disable no-nested-ternary */ /* eslint-disable no-underscore-dangle */ function _define_property(obj, key, value) {
    if (key in obj) {
...
export class PrismaObjectFieldBuilder extends RootBuilder {
    ...
    constructor(name, builder, model, fieldMap, graphqlKind = "Object") {
        ...
        _define_property(this, "exposeFloat", this.createExpose("Float"));
        _define_property(this, "exposeInt", this.createExpose("Int"));
        _define_property(this, "exposeID", this.createExpose("ID"));
        _define_property(this, "exposeString", this.createExpose("String"));
        _define_property(this, "exposeBooleanList", this.createExpose([
            "Boolean"
        ]));
        ...
        _define_property(this, "withAuth", withAuth);
        _define_property(this, "relatedConnection", function relatedConnection(name, { maxSize = this.builder.options.prisma.maxConnectionSize, defaultSize = this.builder.options.prisma.defaultConnectionSize, cursor: cursorValue, query, resolve, extensions, totalCount, description, ...options }, connectionOptions = {}, edgeOptions = {}) {
            const relationField = getRelation(this.model, this.builder, name);
            var _options_type;
            const ref = (_options_type = options.type) !== null && _options_type !== void 0 ? _options_type : getRefFromModel(relationField.type, this.builder);
            let typeName;
                ...
                extensions: {
                    ...
                    pothosPrismaLoaded: (value, info) => {
                        ...
                        const totalCountOnly = selections.every((selection) => {
                            var _selection_selectionSet;
                            return ((_selection_selectionSet = selection.selectionSet) === null || _selection_selectionSet === void 0 ? void 0 : _selection_selectionSet.selections.length) === 1 && selection.selectionSet.selections.every((s) => {
                                var _fields_s_name_value_extensions, _fields_s_name_value;
                                return s.kind === Kind.FIELD && ((_fields_s_name_value = fields[s.name.value]) === null || _fields_s_name_value === void 0 ? void 0 : (_fields_s_name_value_extensions = _fields_s_name_value.extensions) === null || _fields_s_name_value_extensions === void 0 ? void 0 : _fields_s_name_value_extensions.pothosPrismaTotalCount);
                            });
                        });
