...
export type PrismaObjectTypeOptions<Types extends SchemaTypes, Model extends PrismaModelTypes, Interfaces extends InterfaceParam<Types>[], FindUnique, Include, Select, Shape extends object> = PrismaObjectImplementationOptions<Types, Model, Interfaces, FindUnique, Select, Shape> & PrismaObjectRefOptions<Types, Model, FindUnique, Include, Select, Shape>;
...
export type PrismaInterfaceImplementationOptions<Types extends SchemaTypes, Model extends PrismaModelTypes, Interfaces extends InterfaceParam<Types>[], FindUnique, Select, Shape extends object> = Omit<PothosSchemaTypes.InterfaceTypeOptions<Types, Shape, Interfaces>, "description" | "fields"> & {
    description?: string | false;
    fields?: PrismaObjectFieldsShape<Types, Model, FindUnique extends null ? true : false, Shape & (FindUnique extends null ? {} : {
        [prismaModelName]?: Model["Name"];
    }), Select>;
};
export type PrismaInterfaceTypeOptions<Types extends SchemaTypes, Model extends PrismaModelTypes, Interfaces extends InterfaceParam<Types>[], FindUnique, Include, Select, Shape extends object> = PrismaInterfaceImplementationOptions<Types, Model, Interfaces, FindUnique, Select, Shape> & PrismaInterfaceRefOptions<Types, Model, FindUnique, Include, Select, Shape>;
type NameOrVariant = {
    name?: never;
    variant?: string;
} | {
...
export type RelationCountOptions<Types extends SchemaTypes, Shape, NeedsResolve extends boolean, Where, Args extends InputFieldMap> = Omit<PothosSchemaTypes.ObjectFieldOptions<Types, Shape, "Int", false, Args, number>, "resolve" | "type"> & (NeedsResolve extends false ? {
...
export type PrismaFieldWithInputOptions<Types extends SchemaTypes, ParentShape, Kind extends FieldKind, Args extends Record<string, InputFieldRef<unknown, "Arg">>, Fields extends Record<string, InputFieldRef<unknown, "InputObject">>, Type extends PrismaRef<PrismaModelTypes> | keyof Types["PrismaTypes"] | [
    ...
    PrismaRef<PrismaModelTypes>
], Model extends PrismaModelTypes, Param extends TypeParam<Types>, Nullable extends FieldNullability<Param>, InputName extends string, ResolveShape, ResolveReturnShape, ArgRequired extends boolean> = Omit<PrismaFieldOptions<Types, ParentShape, Type, Model, Param, Args & {
...
export type RelatedConnectionOptions<Types extends SchemaTypes, Model extends PrismaModelTypes, Field extends Model["ListRelations"], Nullable extends boolean, Args extends InputFieldMap, NeedsResolve extends boolean> = Omit<PothosSchemaTypes.ObjectFieldOptions<Types, Model["Shape"], ObjectRef<unknown>, Nullable, InputFieldsFromShape<PothosSchemaTypes.DefaultConnectionArguments> & (InputFieldMap extends Args ? {} : Args), unknown>, "args" | "description" | "resolve" | "type"> & Omit<PothosSchemaTypes.ConnectionFieldOptions<Types, Model["Shape"], ObjectRef<unknown>, false, false, Nullable, Args, unknown>, "resolve" | "type"> & (InputShapeFromFields<Args> & PothosSchemaTypes.DefaultConnectionArguments extends infer ConnectionArgs ? (NeedsResolve extends false ? {
    resolve?: (query: {
        include?: Model["Include"];
        cursor?: Model["WhereUnique"];
        take: number;
...
export type PrismaConnectionShape<Types extends SchemaTypes, T, Parent, Args extends InputFieldMap> = (ShapeFromConnection<PothosSchemaTypes.ConnectionShapeHelper<Types, T, false>> extends infer Shape ? Shape & {
    parent: Parent;
    ...
    {
        edges: MaybePromise<readonly (infer Edge)[]>;
    }
] ? Omit<C, "edges"> & {
    edges: MaybePromise<(Edge & {
        connection: C;
    })[]>;
} : C : never;
...
export type UniqueFieldsFromWhereUnique<T> = string & (UniqueFieldsExtendedWhereUnique<T> extends infer K ? [
    K
] extends [
    never
] ? keyof T : K : never);
