        ...
        >
          ...
          <SelectPrimitive.Viewport className="p-1">
            {loading ? (
              ...
              >
                <SelectPrimitive.ItemText>Erro ao carregar times</SelectPrimitive.ItemText>
              </SelectPrimitive.Item>
            ) : teams.length === 0 ? (
              <SelectPrimitive.Item
                value="empty"
                ...
                className="relative flex items-center h-9 rounded-sm pl-8 pr-2 text-sm outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50"
              >
                <SelectPrimitive.ItemText>Nenhum time encontrado</SelectPrimitive.ItemText>
              </SelectPrimitive.Item>
            ) : (
              teams.map((team) => (
                <SelectPrimitive.Item
                ...
                >
                  ...
                  <SelectPrimitive.ItemText>{team.name}</SelectPrimitive.ItemText>
                </SelectPrimitive.Item>
              ))
            )}
